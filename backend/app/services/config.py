...
FRONTEND_URL_S3=os.getenv("FRONTEND_URL_S3")
RUNPOD_URL=os.getenv("RUNPOD_URL")

TRAINING_TIME_OUT_SEC=os.getenv("TRAINING_TIME_OUT_SEC", 30)
INFERENCE_TIME_OUT_SEC=os.getenv("INFERENCE_TIME_OUT_SEC", 30)
